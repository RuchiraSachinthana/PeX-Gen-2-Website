...
const PexGenPhilosopySection = () => {
  return (
    <>
      {/* Desktop Version */}
      <div
        className="hidden md:block w-full bg-cover bg-center bg-no-repeat relative py-16 text-white before:absolute before:inset-0 before:bg-black before:opacity-50"
