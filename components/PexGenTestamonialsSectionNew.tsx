  ...
  return (
    <div className="w-full md:bg-[#0e685b] py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Tablet View */}
        <div className="hidden md:flex lg:hidden gap-4 items-stretch">
          {/* Left Card - Trusted by Industry Leaders */}
          <motion.div
            className="relative flex-shrink-0"
            initial={{ opacity: 0, x: -50 }}
          ...
          {/* Right Card - Testimonial */}
          <motion.div
            className="rounded-tl-3xl rounded-br-3xl rounded-2xl p-6 flex-1 relative border-2 border-yellow-400"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex gap-4 items-center mt-3 justify-center">
                  {/* Profile Image */}
                  <div className="flex-shrink-0">
                    <div className="w-24 h-24 rounded-xl overflow-hidden bg-gray-300">
                      <Image
                        src={testimonials[currentIndex].image}
                        alt={testimonials[currentIndex].name}
                        width={96}
                ...
                {/* Author Info */}
                <div className="mt-3">
                  <p className="text-[#FFC700] text-base">
                    {testimonials[currentIndex].name}
                  </p>
                  <p className="text-[#FFC700] text-xs">
                    {testimonials[currentIndex].designation}
                  </p>
                </div>
              </motion.div>
            ...
            <motion.button
              onClick={handleNext}
              className="absolute top-0 right-0 bg-[#FFC700] hover:bg-[#e6b300] text-black p-2.5 rounded-xl flex items-center justify-center transition-colors cursor-pointer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              aria-label="Next testimonial"
            >
            ...
            <motion.button
              onClick={handlePrevious}
              className="absolute bottom-0 left-0 bg-[#FFC700] hover:bg-[#e6b300] text-black p-2.5 rounded-xl flex items-center justify-center transition-colors cursor-pointer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              aria-label="Previous testimonial"
            >
