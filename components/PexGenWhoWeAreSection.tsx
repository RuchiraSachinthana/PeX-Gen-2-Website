  ...
  return (
    <section className="w-full relative">
      ...
      <div className="hidden md:block lg:hidden">
        ...
        <div className="w-full bg-white py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-6">
              ...
              >
                <motion.h2
                  className="text-3xl text-teal-800 mb-4"
                  initial={{ opacity: 0, scale: 0.9 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: 0.4 }}
        ...
        {/* Yellow Background Section - Full Width */}
        <div className="w-full relative bg-yellow-300 py-12 px-4">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              >
                <div className="grid grid-cols-3 gap-4">
                  {/* Year Experience Card */}
                  <motion.div
                    className="bg-teal-700 rounded-xl p-4 text-white shadow-lg"
                    initial={{ opacity: 0, y: 50, scale: 0.9 }}
                    whileInView={{ opacity: 1, y: 0, scale: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, delay: 1.0 }}
                  ...
                  >
                    <motion.div
                      className="text-3xl text-yellow-400 mb-1"
                      initial={{ opacity: 0, scale: 0.5 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.5, delay: 1.2 }}
                  ...
                  >
                    ...
                    <div className="text-lg">ISO PROJECTS</div>
                  ...
                  >
                    ...
                    <div className="text-lg">TRAINED</div>
                  </motion.div>
                </div>
              </motion.div>
            </div>
        ...
        {/* Award Image - Absolutely positioned on the right */}
        <motion.div
        ...
        {/* Award Caption */}
        <motion.div
          className="text-center bottom-10 right-10 absolute mt-6"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 1.8 }}
