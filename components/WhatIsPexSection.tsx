...
export default function WhatIsPexSection() {
  return (
    <>
      {/* ========================================== */}
      {/* Desktop Version (1024px+) - UNCHANGED */}
      {/* ========================================== */}
      <section id="what-is-pex-gen" className="hidden lg:flex flex-col items-center bg-white justify-center py-16 px-4 text-center">
      ...
      {/* ========================================== */}
      <section id="what-is-pex-gen-tablet" className="hidden md:flex lg:hidden flex-col items-center bg-white justify-center py-14 px-6 text-center">
