    ...
    <div className="w-full md:pt-20 md:pb-20 py-5 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 px-2 md:px-4">
        ...
        <div className="flex md:hidden max-w-[370px] mx-auto flex-col gap-3 items-center">
          ...
          {/* Video - Mobile */}
          <motion.div
            className="relative w-full max-w-sm h-64 rounded-3xl p-1 shadow-2xl bg-[linear-gradient(to_bottom_right,#0e685b,#10b981,#0e685b)]"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        <div className="hidden md:flex lg:hidden gap-2 justify-between max-w-4xl mx-auto">
          {/* left section */}
          <motion.div
