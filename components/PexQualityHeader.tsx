      ...
      <div className="relative z-100 w-full max-w-6xl mx-auto ">
        ...
        <div className="flex items-end justify-end min-h-100  md:min-h-[60vh] sm:min-h-[70vh]">
          <div className="text-right  sm:ml-0 mr-5 max-w-6xl">
            ...
            <motion.p
              className="text-md sm:text-3xl md:text-44xl lg:text-4xl font-semibold  mb-1 sm:mb-3 text-white drop-shadow-lg uppercase"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3, duration: 0.8 }}
            >
            ...
            <motion.p
              className="tesxt:sm sm:text-xl md:text-3xl lg:text-3xl mb-1 sm:mb-3 text-white drop-shadow-lg uppercase"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3, duration: 0.8 }}
            >
