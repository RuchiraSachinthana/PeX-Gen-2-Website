...
// PEx Quality Page Metadata
export const pexQualityMetadata: Metadata = {
...
// PEx Food Page Metadata
export const pexFoodMetadata: Metadata = {
...
// PEx Gen Page Metadata
export const pexGenMetadata: Metadata = {
...
export const blogMetadata: Metadata = {
  ...
  description:
    "Expert insights on ISO compliance, quality management, performance improvement, and operational excellence for SMEs. Learn from industry best practices, case studies, and strategic guidance.",
  keywords: [
    "ISO compliance blog",
