  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div
          className="absolute top-10 right-10 w-48 h-48 md:w-72 md:h-72 bg-amber-400 rounded-full opacity-20 blur-3xl"
          animate={{ x: [0, 30, 0], y: [0, 20, 0] }}
          transition={{ duration: 8, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-10 left-10 w-64 h-64 md:w-96 md:h-96 bg-orange-400 rounded-full opacity-15 blur-3xl"
          animate={{ x: [0, -30, 0], y: [0, -20, 0] }}
      ...
      <div className="w-full bg-white">
        <div className="max-w-4xl mx-auto px-4 py-20">
          <div className="text-center">
            <h2 className="text-4xl mb-4 text-gray-800">Key Capabilities</h2>
            <p className="text-lg text-gray-600">
              Powerful features designed to exceed your expectations.
            </p>
          </div>
        </div>
      </div>
